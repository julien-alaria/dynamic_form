...
function render_book_form($genres, $edit_book = null) {
    $is_edit_book = !empty($edit_book);
...
<form action="" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <input type="text" id="title_book" name="title" required value="<?= escape($is_edit_book ? $edit_book['title'] : post('title', '')); ?>">

        <label for="author_book">Auteur:</label>
        <input type="text" id="author_book" name="author" required value="<?= escape($is_edit_book ? $edit_book['author'] : post('author', '')); ?>">

        <label for="isbn_book">Isbn:</label>
        <input type="text" id="isbn_book" name="isbn" required value="<?= escape($is_edit_book ? $edit_book['isbn'] : post('isbn', '')); ?>">
        ...
        <input type="number" id="pages_nb_book" name="pages_nb" required value="<?= escape($is_edit_book ? $edit_book['pages_nb'] : post('pages_nb')); ?>">

        <label for="summary_book">Résumé:</label>
        <textarea name="summary" id="summary_book" rows="6" required><?= escape($is_edit_book ? $edit_book['summary'] : post('summary', '')); ?></textarea>


        <label for="publication_year_book">Année de publication:</label>
        <input type="number" id="publication_year_book" name="publication_year" required value="<?= escape($is_edit_book ? $edit_book['publication_year'] : post('publication_year')); ?>">

        <label for="image_book">Image:</label>
        <input type="file" id="image_book" name="image">

        <label for="stock_book">Stock:</label>
        <input type="number" id="stock_book" name="stock" required value="<?= escape($is_edit_book ? $edit_book['stock'] : post('stock')); ?>">
...
function render_movie_form($genres, $edit_movie = null) {
    $is_edit_movie = !empty($edit_movie);
...
<form action="" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <input type="text" id="title_movie" name="title" required value="<?= escape($is_edit_movie ? $edit_movie['title'] : post('title', '')); ?>">

        <label for="director_movie">Réalisateur:</label>
        <input type="text" id="director_movie" name="director" required value="<?= escape($is_edit_movie ? $edit_movie['director'] : post('director', '')); ?>">

        <label for="year_movie">Année de sortie:</label>
        <input type="number" id="year_movie" name="year" required value="<?= escape($is_edit_movie ? $edit_movie['year'] : post('year', '')); ?>">
        ...
        <input type="number" id="duration_movie" name="duration" required value="<?= escape($is_edit_movie ? $edit_movie['duration'] : post('duration', '')); ?>">

        <label for="synopsis_movie">Synopsis:</label>
        <textarea name="synopsis" id="synopsis_movie" rows="6" required>
            <?= escape($is_edit_movie ? $edit_movie['synopsis'] : post('synopsis', '')); ?>
        </textarea>
        ...
        <input type="number" id="stock_movie" name="stock" required value="<?= escape($is_edit_movie ? $edit_movie['stock'] : post('stock', '')); ?>">
...
function render_video_game_form($genres, $edit_video_game = null) {
    $is_edit_video_game = !empty($edit_video_game);
...
<form action="" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <?php if ($is_edit_video_game): ?>
                <input type="hidden" name="video_game_id" value="<?= $edit_video_game['id']; ?>">
        <?php endif; ?>

        <label for="title_video_game">Titre:</label>
        <input type="text" id="title_video_game" name="title" required value="<?= escape($is_edit_video_game ? $edit_video_game['title'] : post('title', '')); ?>">

        <label for="publisher_video_game">Editeur:</label>
        <input type="text" id="publisher_video_game" name="publisher" required value="<?= escape($is_edit_video_game ? $edit_video_game['publisher'] : post('publisher', '')); ?>">

        <label for="platform_video_game">Plateforme:</label>
        <select name="platform" id="platform_video_game" required>
            <option value="">Sélectionnez une plateforme</option>
            <option value="PC" <?= $is_edit_video_game && $edit_video_game['platform'] === 'PC' ? 'selected' : '' ?>>PC</option>
            <option value="Playstation" <?= $is_edit_video_game && $edit_video_game['platform'] === 'Playstation' ? 'selected' : '' ?>>Playstation</option>
            <option value="Xbox" <?= $is_edit_video_game && $edit_video_game['platform'] === 'Xbox' ? 'selected' : '' ?>>Xbox</option>
            <option value="Nintendo" <?= $is_edit_video_game && $edit_video_game['platform'] === 'Nintendo' ? 'selected' : '' ?>>Nintendo</option>
            <option value="Mobile" <?= $is_edit_video_game && $edit_video_game['platform'] === 'Mobile' ? 'selected' : '' ?>>Mobile</option>
        </select>
        ...
        <select name="minimum_age" id="minimum_age_video_game" required>
            ...
            <option value="3" <?= $is_edit_video_game && $edit_video_game['minimum_age'] == 3 ? 'selected' : '' ?>>3</option>
            <option value="7" <?= $is_edit_video_game && $edit_video_game['minimum_age'] == 7 ? 'selected' : '' ?>>7</option>
            <option value="12" <?= $is_edit_video_game && $edit_video_game['minimum_age'] == 12 ? 'selected' : '' ?>>12</option>
            <option value="16" <?= $is_edit_video_game && $edit_video_game['minimum_age'] == 16 ? 'selected' : '' ?>>16</option>
            <option value="18" <?= $is_edit_video_game && $edit_video_game['minimum_age'] == 18 ? 'selected' : '' ?>>18</option>
        </select>

        <label for="description_video_game">Description:</label>
        <textarea name="description" id="description_video_game" rows="6" required>
            <?= escape($is_edit_video_game ? $edit_video_game['description'] : post('description', '')); ?>
        </textarea>
        ...
        <input type="number" id="stock_video_game" name="stock" required value="<?= escape($is_edit_video_game ? $edit_video_game['stock'] : post('stock', '')); ?>">
            ...
            <div class="card">
                <div class="card-content">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="submit" name="update_video_game" value="MODIFIER">
                    </form>
                    <form action="" method="post">
                        <input type="hidden" name="video_game_id" value="<?= $video_game['id']; ?>">
