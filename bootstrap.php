 ...
 */
function create_test_user($name = 'Test User', $lastname = 'Test Lastname', $email = 'test@example.com', $password = 'password123') {
    return create_user($name, $lastname, $email, $password);
}
